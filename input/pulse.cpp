...
void getPulseDefaultSink(void* data) {
  ...
  pulseaudio_context = pa_context_new(mainloop_api, "tblvis device list");
...
void* input_pulse(void* data) {
  ...
  if (!(s = pa_simple_new(NULL, "tblvis", PA_STREAM_RECORD, audio->source, "audio for tblvis", &ss, NULL, &pb, &error))) {
    fprintf(stderr,
            __FILE__": Could not open pulseaudio source: %s, %s. To find a list of your pulseaudio sources run 'pacmd list-sources'\n",
